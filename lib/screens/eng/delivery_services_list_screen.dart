...
class DeliveryServicesListScreen extends StatefulWidget {
  const DeliveryServicesListScreen({super.key});

  @override
  State<DeliveryServicesListScreen> createState() =>
      _DeliveryServicesListScreenState();
}

class _DeliveryServicesListScreenState
    extends State<DeliveryServicesListScreen> {
  ...
  Future<void> _fetchServices() async {
    ...
    try {
      ...
      final uri = Uri.parse(
          'https://hcodecraft.com/felwa/api/delivery-services?page=1');
      ...
      if (response.statusCode >= 200 && response.statusCode < 300) {
        ...
        final list =
            (data is Map && data['data'] is Map && data['data']['data'] is List)
          ...
          onTap: () {
            if (item.categoryId != null) {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (_) =>
                      DeliveryServiceDetailScreen(categoryId: item.categoryId!),
                ),
              );
            }
          },
